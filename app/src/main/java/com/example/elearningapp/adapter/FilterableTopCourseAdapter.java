...
public class FilterableTopCourseAdapter extends RecyclerView.Adapter<FilterableTopCourseAdapter.TopCourseViewHolder> {
    ...
    public FilterableTopCourseAdapter(@NonNull Context context, List<CourseListItem> courseListItemList,
    ...
    public TopCourseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new FilterableTopCourseAdapter.TopCourseViewHolder(view, clickHelper, context);
    }
